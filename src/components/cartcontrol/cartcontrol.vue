<template>
  <div class="cartcontrol">
    <div class="cart-decrease inline-block" v-show="food.count > 0" @click.stop.prevent="decreaseCart" transition="move">
    ...
    <div class="cart-add inline-block icon-add_circle" @click.stop.prevent="addCart"></div>
  </div>
</template>
